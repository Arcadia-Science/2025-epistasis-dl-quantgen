...
in_data = pk.load(open('arapheno/arapheno_scaled_study3_4_5_pheno.pk','rb'))
...
pk.dump(out_dict_train, open('LTEE_presence_absence_train.pk','wb'))
...
pk.dump(out_dict_test, open('LTEE_presence_absence_test.pk','wb'))
