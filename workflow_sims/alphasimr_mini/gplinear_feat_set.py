...
base_file_name_out = 'experiments/test_sim_qhaplo_2k_500sites_100qtl_Ve0_FEATURE_SELN.csv'
...
def run_lasso_mlp_pipeline(l1_weight=0.01, feature_threshold=1e-4,
                          mlp_hidden_size=64, max_selected_features=200):
    """
...
def main():
    results = run_lasso_mlp_pipeline(
        ...
        feature_threshold=0.075,       # Threshold for feature selection
