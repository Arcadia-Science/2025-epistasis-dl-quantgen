...
write.table(GP_p, p_out, quote = F, col.names = T, row.names = F)
...
write.table(loci_all, eff_out, quote = F, col.names = T, row.names = F)
...
write.table(GP_g, g_out, quote = F, col.names = T, row.names = F)
