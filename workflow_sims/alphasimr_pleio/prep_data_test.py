...
base_file_in = 'alphasim_out/qhaplo_200qtl_10000n_0pleio_10trait_0.5H2_uncup'
base_file_out = 'input_data/qhaplo_200qtl_10000n_0pleio_10trait_0.5H2_uncup'
...
phen_file = open(f'{base_file_in}_p.txt' , 'r')
...
genotype_file = open(f'{base_file_in}_g.txt' , 'r')
...
save_to_hdf5(out_dict_train, f'{base_file_out}_train.hdf5' ,)
...
save_to_hdf5(out_dict_test, f'{base_file_out}_test.hdf5')
