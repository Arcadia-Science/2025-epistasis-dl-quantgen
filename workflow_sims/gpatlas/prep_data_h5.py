...
phen_file = open(snakemake.input['input_pheno'] , 'r')
...
genotype_file = open(snakemake.input['input_geno'] , 'r')
...
save_to_hdf5(out_dict_train, snakemake.output['train_data_input'])
